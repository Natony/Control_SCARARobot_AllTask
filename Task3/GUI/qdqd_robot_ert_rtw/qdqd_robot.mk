###########################################################################
## Makefile generated for component 'qdqd_robot'. 
## 
## Makefile     : qdqd_robot.mk
## Generated on : Thu Dec 28 00:21:02 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/qdqd_robot.elf
...
PRODUCT_NAME              = qdqd_robot
MAKEFILE                  = qdqd_robot.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2022b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2022b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = D:/TAI LIEU/NAM 4/TAILIEU_TT_ROBOT/Control_SCARARobot-main/Control_SCARARobot-main/GUI
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH                 = C:/Users/Admin/DOCUME~1/MATLAB/R2022b/ARDUIN~1/ARDUIN~1/FASTER~1
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/qdqd_robot.elf
...
DEFINES_STANDARD = -DMODEL=qdqd_robot -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_ServoWriteRead.o xcp_ext_mode.o qdqd_robot.o qdqd_robot_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/qdqd_robot_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/qdqd_robot_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/qdqd_robot_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/qdqd_robot_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


qdqd_robot.o : $(START_DIR)/qdqd_robot_ert_rtw/qdqd_robot.c
	$(CC) $(CFLAGS) -o "$@" "$<"


qdqd_robot_data.o : $(START_DIR)/qdqd_robot_ert_rtw/qdqd_robot_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/qdqd_robot_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/qdqd_robot_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/qdqd_robot_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
