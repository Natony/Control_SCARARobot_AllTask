###########################################################################
## Makefile generated for component 'test_servo'. 
## 
## Makefile     : test_servo.mk
## Generated on : Thu Dec 28 00:37:44 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/test_servo.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/test_servo.elf
...
DEFINES_STANDARD = -DMODEL=test_servo -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_ServoWriteRead.o xcp_ext_mode.o rtGetInf.o rtGetNaN.o rt_nonfinite.o test_servo.o test_servo_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/test_servo_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/test_servo_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/test_servo_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/test_servo_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/test_servo_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/test_servo_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/test_servo_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"


test_servo.o : $(START_DIR)/test_servo_ert_rtw/test_servo.c
	$(CC) $(CFLAGS) -o "$@" "$<"


test_servo_data.o : $(START_DIR)/test_servo_ert_rtw/test_servo_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
