...
#ifndef RTW_HEADER_test_servo_types_h_
#define RTW_HEADER_test_servo_types_h_
#include "rtwtypes.h"
...
typedef struct P_test_servo_T_ P_test_servo_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_test_servo_T RT_MODEL_test_servo_T;

#endif                                 /* RTW_HEADER_test_servo_types_h_ */
