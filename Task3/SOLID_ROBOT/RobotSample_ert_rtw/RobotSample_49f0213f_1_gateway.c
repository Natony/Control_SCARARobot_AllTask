...
#include "nesl_rtw.h"
#include "RobotSample_49f0213f_1.h"
#include "RobotSample_49f0213f_1_gateway.h"

void RobotSample_49f0213f_1_gateway(void)
{
  NeModelParameters modelparams = { (NeSolverType) 0, 0.001, 0.001, 0.001, 0, 0,
    (NeModifyAbsTol) 0, 0.01, 0, 0, 0, 0, (SscLoggingSetting) 0, 618812719, 1, };
  ...
  RobotSample_49f0213f_1_dae(&dae,
    &modelparams,
    &solverparams);
  nesl_register_simulator_group("RobotSample/Subsystem/Solver Configuration_1",
    1,
    &dae,
    &solverparams,
    &modelparams,
