...
void RobotSample_49f0213f_1_resetSimStateVector(const void *mech, double *state)
{
  double xx[1];
  (void) mech;
  xx[0] = 0.0;
...
void RobotSample_49f0213f_1_perturbSimJointPrimitiveState(const void *mech,
...
void RobotSample_49f0213f_1_perturbFlexibleBodyState(const void *mech, size_t
...
void RobotSample_49f0213f_1_constructStateVector(const void *mech, const double *
...
void RobotSample_49f0213f_1_extractSolverStateVector(const void *mech, const
...
boolean_T RobotSample_49f0213f_1_isPositionViolation(const void *mech, const
...
boolean_T RobotSample_49f0213f_1_isVelocityViolation(const void *mech, const
  RuntimeDerivedValuesBundle *rtdv, const int *eqnEnableFlags, const double
  *state, const int *modeVector)
{
  const double *rtdvd = rtdv->mDoubles.mValues;
...
PmfMessageId RobotSample_49f0213f_1_projectStateSim(const void *mech, const
...
void RobotSample_49f0213f_1_computeConstraintError(const void *mech, const
...
boolean_T RobotSample_49f0213f_1_hasJointDisToNormModeChange(const void *mech,
...
PmfMessageId RobotSample_49f0213f_1_performJointDisToNormModeChange(const void
...
void RobotSample_49f0213f_1_onModeChangedCutJoints(const void *mech, const int
