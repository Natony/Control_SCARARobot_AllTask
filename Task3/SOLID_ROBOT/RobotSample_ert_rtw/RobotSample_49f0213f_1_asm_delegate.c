...
void RobotSample_49f0213f_1_setTargets(const RuntimeDerivedValuesBundle *rtdv,
  CTarget *targets)
{
  (void) rtdv;
  (void) targets;
...
void RobotSample_49f0213f_1_resetAsmStateVector(const void *mech, double *state)
{
  double xx[1];
  (void) mech;
  xx[0] = 0.0;
...
void RobotSample_49f0213f_1_initializeTrackedAngleState(const void *mech, const
...
void RobotSample_49f0213f_1_computeDiscreteState(const void *mech, const
...
void RobotSample_49f0213f_1_adjustPosition(const void *mech, const double
...
void RobotSample_49f0213f_1_perturbAsmJointPrimitiveState(const void *mech,
...
void RobotSample_49f0213f_1_computePosDofBlendMatrix(const void *mech, size_t
...
void RobotSample_49f0213f_1_computeVelDofBlendMatrix(const void *mech, size_t
  stageIdx, size_t primIdx, const double *state, int partialType, double *matrix)
{
  (void) mech;
  (void) stageIdx;
...
void RobotSample_49f0213f_1_projectPartiallyTargetedPos(const void *mech, size_t
...
void RobotSample_49f0213f_1_propagateMotion(const void *mech, const
...
size_t RobotSample_49f0213f_1_computeAssemblyError(const void *mech, const
...
size_t RobotSample_49f0213f_1_computeAssemblyJacobian(const void *mech, const
...
size_t RobotSample_49f0213f_1_computeFullAssemblyJacobian(const void *mech,
...
boolean_T RobotSample_49f0213f_1_isInKinematicSingularity(const void *mech,
...
void RobotSample_49f0213f_1_convertStateVector(const void *asmMech, const
