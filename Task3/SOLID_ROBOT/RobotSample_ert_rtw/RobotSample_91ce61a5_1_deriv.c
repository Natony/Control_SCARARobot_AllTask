...
#include "RobotSample_91ce61a5_1_geometries.h"

PmfMessageId RobotSample_91ce61a5_1_compDerivs(const RuntimeDerivedValuesBundle *
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  if (ii[0] != 0) {
    return sm_ssci_recordRunTimeError(
      ...
      "'RobotSample/Subsystem1/Cylindrical1' has a degenerate mass distribution on its follower side.",
      neDiagMgr);
  }
  ...
  if (ii[0] != 0) {
    return sm_ssci_recordRunTimeError(
      "physmod:sm:core:compiler:mechanism:mechanism:degenerateMassFoll",
      "'RobotSample/Subsystem1/Cylindrical' has a degenerate mass distribution on its follower side.",
      neDiagMgr);
  }
...
PmfMessageId RobotSample_91ce61a5_1_numJacPerturbLoBounds(const
...
PmfMessageId RobotSample_91ce61a5_1_numJacPerturbHiBounds(const
  RuntimeDerivedValuesBundle *rtdv, const int *eqnEnableFlags, const double
  *state, const int *modeVector, const double *input, const double *inputDot,
  const double *inputDdot, const double *discreteState, double *bounds, double
  *errorResult, NeuDiagnosticManager *neDiagMgr)
