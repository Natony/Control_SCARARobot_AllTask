...
const NeZCData *RobotSample_871ffa15_1_ZCData = NULL;
PmfMessageId RobotSample_871ffa15_1_computeAsmModeVector(const double *input,
...
PmfMessageId RobotSample_871ffa15_1_computeSimModeVector(const double *input,
  const double *inputDot, const double *inputDdot, int *modeVector, double
  *errorResult, NeuDiagnosticManager *neDiagMgr)
{
  (void) input;
...
PmfMessageId RobotSample_871ffa15_1_computeZeroCrossings(const
