...
#include "nesl_rtw.h"
#include "RobotSample_871ffa15_1.h"
#include "RobotSample_871ffa15_1_gateway.h"

void RobotSample_871ffa15_1_gateway(void)
{
  NeModelParameters modelparams = { (NeSolverType) 0, 0.001, 0.001, 0.001, 0, 0,
    (NeModifyAbsTol) 0, 0.01, 0, 0, 0, 0, (SscLoggingSetting) 0, 619854984, 1, 0,
    0, };
  ...
  RobotSample_871ffa15_1_dae(&dae,
    &modelparams,
    &solverparams);
  nesl_register_simulator_group("RobotSample/Subsystem4/Solver Configuration_1",
    1,
    &dae,
    &solverparams,
    &modelparams,
