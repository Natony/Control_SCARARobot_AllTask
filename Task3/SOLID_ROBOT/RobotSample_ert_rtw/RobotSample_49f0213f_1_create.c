 ...
 * This file is generated for the Simscape network associated with the solver block 'RobotSample/Subsystem/Solver Configuration'.
 */
...
extern const NeAssertData RobotSample_49f0213f_1_assertData[];
extern const NeZCData RobotSample_49f0213f_1_ZCData[];
void RobotSample_49f0213f_1_computeRuntimeParameters(
  const double *runtimeRootVariables,
  double *runtimeParameters);
void RobotSample_49f0213f_1_validateRuntimeParameters(
  const double *runtimeParameters,
  int32_T *assertSatisfactionFlags);
void RobotSample_49f0213f_1_computeAsmRuntimeDerivedValues(
  const double *runtimeParameters,
  RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle);
void RobotSample_49f0213f_1_computeSimRuntimeDerivedValues(
  const double *runtimeParameters,
  RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle);
void RobotSample_49f0213f_1_initializeGeometries(
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle);
PmfMessageId RobotSample_49f0213f_1_compDerivs(
...
PmfMessageId RobotSample_49f0213f_1_numJacPerturbLoBounds(
  const RuntimeDerivedValuesBundle *,
  const int *,
  const double *,
  const int *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId RobotSample_49f0213f_1_numJacPerturbHiBounds(
  const RuntimeDerivedValuesBundle *,
  const int *,
  const double *,
  const int *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId RobotSample_49f0213f_1_checkDynamics(
  const RuntimeDerivedValuesBundle *,
  const double *,
  const double *, const double *, const double *,
  const double *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId RobotSample_49f0213f_1_compOutputsDyn(
  const RuntimeDerivedValuesBundle *,
  const int *,
  const double *,
  const int *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId RobotSample_49f0213f_1_compOutputsKin(
  const RuntimeDerivedValuesBundle *,
  const double *,
  const int *,
  const double *, const double *, const double *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId RobotSample_49f0213f_1_compOutputs (
  const RuntimeDerivedValuesBundle *,
  const double *,
  const int *,
  const double *, const double *, const double *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId RobotSample_49f0213f_1_computeAsmModeVector(
  const double *, const double *, const double *,
  int *,
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId RobotSample_49f0213f_1_computeSimModeVector(
  const double *, const double *, const double *,
  int *,
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId RobotSample_49f0213f_1_computeZeroCrossings(
  const RuntimeDerivedValuesBundle *,
  const double *,
  const double *, const double *, const double *,
  const double *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId RobotSample_49f0213f_1_recordLog(
  const RuntimeDerivedValuesBundle *,
  const int *,
  const double *,
  const int *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
void RobotSample_49f0213f_1_setTargets(
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  CTarget *targets);
void RobotSample_49f0213f_1_resetAsmStateVector(const void *mech, double
  *stateVector);
void RobotSample_49f0213f_1_resetSimStateVector(const void *mech, double
  *stateVector);
void RobotSample_49f0213f_1_initializeTrackedAngleState(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const int *modeVector,
  const double *motionData,
  double *stateVector);
void RobotSample_49f0213f_1_computeDiscreteState(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  double *stateVector);
void RobotSample_49f0213f_1_adjustPosition(
  const void *mech,
  const double *dofDeltas,
  double *stateVector);
void RobotSample_49f0213f_1_perturbAsmJointPrimitiveState(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  double magnitude,
  ...
  double *stateVector);
void RobotSample_49f0213f_1_perturbSimJointPrimitiveState(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  double magnitude,
  boolean_T doPerturbVelocity,
  double *stateVector);
void RobotSample_49f0213f_1_perturbFlexibleBodyState(
  const void *mech,
  size_t stageIdx,
  double magnitude,
  boolean_T doPerturbVelocity,
  double *stateVector);
void RobotSample_49f0213f_1_computePosDofBlendMatrix(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  ...
  int partialType,
  double *matrix);
void RobotSample_49f0213f_1_computeVelDofBlendMatrix(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  const double *stateVector,
  int partialType,
  double *matrix);
void RobotSample_49f0213f_1_projectPartiallyTargetedPos(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  ...
  int partialType,
  double *stateVector);
void RobotSample_49f0213f_1_propagateMotion(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const double *stateVector,
  double *motionData);
size_t RobotSample_49f0213f_1_computeAssemblyError(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  ...
  const double *motionData,
  double *error);
size_t RobotSample_49f0213f_1_computeAssemblyJacobian(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  size_t constraintIdx,
  ...
  const double *motionData,
  double *J);
size_t RobotSample_49f0213f_1_computeFullAssemblyJacobian(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const double *stateVector,
  const int *modeVector,
  const double *motionData,
  double *J);
boolean_T RobotSample_49f0213f_1_isInKinematicSingularity(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  size_t constraintIdx,
  const int *modeVector,
  const double *motionData);
void RobotSample_49f0213f_1_convertStateVector(
  const void *asmMech,
...
void RobotSample_49f0213f_1_constructStateVector(
  const void *mech,
...
void RobotSample_49f0213f_1_extractSolverStateVector(
  const void *mech,
  const double *fullStateVector,
  double *solverStateVector);
boolean_T RobotSample_49f0213f_1_isPositionViolation(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const int *constraintEqnEnableFlags,
  const double *stateVector,
  const int *modeVector);
boolean_T RobotSample_49f0213f_1_isVelocityViolation(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const int *constraintEqnEnableFlags,
  const double *stateVector,
  const int *modeVector);
PmfMessageId RobotSample_49f0213f_1_projectStateSim(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const int *constraintEqnEnableFlags,
  const int *modeVector,
  double *stateVector,
  void *neDiagMgr);
void RobotSample_49f0213f_1_computeConstraintError(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const double *stateVector,
  const int *modeVector,
  double *error);
void RobotSample_49f0213f_1_resetModeVector(const void *mech, int *modeVector);
boolean_T RobotSample_49f0213f_1_hasJointDisToNormModeChange(
  const void *mech,
  const int *prevModeVector,
  const int *modeVector);
PmfMessageId RobotSample_49f0213f_1_performJointDisToNormModeChange(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const int *constraintEqnEnableFlags,
  const int *prevModeVector,
  ...
  double *stateVector,
  void *neDiagMgr);
void RobotSample_49f0213f_1_onModeChangedCutJoints(
  const void *mech,
  const int *prevModeVector,
  const int *modeVector,
  double *stateVector);
PmfMessageId RobotSample_49f0213f_1_assemble(const double *u, double *udot,
  double *x,
  NeuDiagnosticManager *neDiagMgr)
{
  (void) x;
  ...
  const NeParameterBundle *paramBundle)
{
  ...
  if (smData->mRuntimeParameterScalars.mN == 0)
    return;
  RobotSample_49f0213f_1_computeRuntimeParameters(
    runtimeRootVariables,
    smData->mRuntimeParameterScalars.mX);
  RobotSample_49f0213f_1_computeAsmRuntimeDerivedValues(
    smData->mRuntimeParameterScalars.mX,
    &dae->mPrivateData->mAsmRuntimeDerivedValuesBundle);
  RobotSample_49f0213f_1_computeSimRuntimeDerivedValues(
    smData->mRuntimeParameterScalars.mX,
    &dae->mPrivateData->mSimRuntimeDerivedValuesBundle);
  RobotSample_49f0213f_1_initializeGeometries
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  (void) systemInput;
  (void) neDiagMgr;
  RobotSample_49f0213f_1_validateRuntimeParameters(
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  if (smData->mCachedDerivativesAvailable)
    ...
    errorId = RobotSample_49f0213f_1_compDerivs(
      &smData->mSimRuntimeDerivedValuesBundle,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  PmfMessageId errorId = NULL;
  double errorResult = 0.0;
  errorId = RobotSample_49f0213f_1_numJacPerturbLoBounds(
    &smData->mSimRuntimeDerivedValuesBundle,
    smData->mSimulationDelegate
    .mRunTimeEnabledEquations.mValues,
    systemInput->mX.mX,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  PmfMessageId errorId = NULL;
  double errorResult = 0.0;
  errorId = RobotSample_49f0213f_1_numJacPerturbHiBounds(
    &smData->mSimRuntimeDerivedValuesBundle,
    smData->mSimulationDelegate
    .mRunTimeEnabledEquations.mValues,
    systemInput->mX.mX,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  errorId = RobotSample_49f0213f_1_compOutputs(
    &smData->mSimRuntimeDerivedValuesBundle,
    systemInput->mX.mX,
    systemInput->mM.mX,
    systemInput->mU.mX,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  PmfMessageId errorId = NULL;
  double errorResult = 0.0;
  errorId = RobotSample_49f0213f_1_computeSimModeVector(
    systemInput->mU.mX,
    systemInput->mU.mX + 3,
    systemInput->mV.mX + 3,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  double errorResult = 0.0;
  return
    RobotSample_49f0213f_1_computeZeroCrossings(
    &smData->mSimRuntimeDerivedValuesBundle,
    systemInput->mX.mX,
    systemInput->mU.mX,
    systemInput->mU.mX + 3,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  RobotSample_49f0213f_1_constructStateVector(
    NULL,
    systemInput->mX.mX,
    systemInput->mU.mX,
    systemInput->mU.mX + 3,
    systemInput->mD.mX,
    fullStateVector);
  errorId = RobotSample_49f0213f_1_recordLog(
    &smData->mSimRuntimeDerivedValuesBundle,
    smData->mSimulationDelegate
    .mRunTimeEnabledEquations.mValues,
    fullStateVector,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  if (errorId == NULL) {
    double result = 0.0;
    errorId = RobotSample_49f0213f_1_checkDynamics(
      &smData->mSimRuntimeDerivedValuesBundle,
      systemInput->mX.mX,
      systemInput->mU.mX,
      systemInput->mU.mX + 3,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  if (smData->mAssemblyModeVector.mN > 0) {
    errorId = RobotSample_49f0213f_1_computeAsmModeVector(
      systemInput->mU.mX,
      systemInput->mU.mX + 3,
      systemInput->mV.mX + 3,
  ...
  RobotSample_49f0213f_1_checkTargets(
    &smData->mSimRuntimeDerivedValuesBundle,
  ...
  void initStateVector(NeDaePrivateData *smData)
{
  ...
  const int32_T stateVectorMap[6] = {
    1, 3, 5, 7, 9, 11
  };

  const CTarget targets[18] = {
    { 0, 10, 0, false, 0, 1, "deg", false, true, +1.000000000000000000e+00,
      false, 1, { -6.851201661484890293e-02, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 10, 0, false, 0, 0, "1", true, true, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 10, 1, false, 0, 1, "mm", false, false, +1.000000000000000000e+00,
      false, 1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 10, 1, false, 0, 0, "1", true, false, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 11, 0, false, 0, 1, "deg", false, true, +1.000000000000000000e+00,
      false, 1, { +7.672941647161127601e-03, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 11, 0, false, 0, 0, "1", true, true, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 11, 1, false, 0, 1, "mm", false, false, +1.000000000000000000e+00,
      false, 1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 11, 1, false, 0, 0, "1", true, false, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 12, 0, false, 0, 1, "deg", false, true, +1.000000000000000000e+00,
      false, 1, { +1.317295224817329469e-01, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 12, 0, false, 0, 0, "1", true, true, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 12, 1, false, 0, 1, "mm", false, false, +1.000000000000000000e+00,
      false, 1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 12, 1, false, 0, 0, "1", true, false, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 10, 0, false, 0, 3, "", false, false, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 10, 0, false, 0, 3, "", true, false, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 11, 0, false, 0, 3, "", false, false, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 11, 0, false, 0, 3, "", true, false, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 12, 0, false, 0, 3, "", false, false, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 12, 0, false, 0, 3, "", true, false, +1.000000000000000000e+00, false,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } }
  };
...
static void initAsserts(NeDaePrivateData *smData)
{
  ...
  if (smData->mNumParamAsserts > 0) {
    const NeAssertData *ad = RobotSample_49f0213f_1_assertData;
    size_t i;
...
static void initZeroCrossings(NeDaePrivateData *smData)
{
  ...
  if (smData->mNumZeroCrossings > 0) {
    const NeZCData *zcd = RobotSample_49f0213f_1_ZCData;
    size_t i;
...
{
  const char *varFullPaths[6] = {
    "Subsystem.Cylindrical.Pz.p",
    "Subsystem.Cylindrical.Pz.v",
    "Subsystem.Cylindrical1.Pz.p",
    "Subsystem.Cylindrical1.Pz.v",
    "Subsystem.Cylindrical2.Pz.p",
    "Subsystem.Cylindrical2.Pz.v"
  };

  const char *varObjects[6] = {
    "RobotSample/Subsystem/Cylindrical",
    "RobotSample/Subsystem/Cylindrical",
    "RobotSample/Subsystem/Cylindrical1",
    "RobotSample/Subsystem/Cylindrical1",
    "RobotSample/Subsystem/Cylindrical2",
    "RobotSample/Subsystem/Cylindrical2"
  };

  smData->mNumVarScalars = 6;
  ...
  void initIoInfo(NeDaePrivateData *smData)
{
  const char *inputPortPaths[3] = {
    "Subsystem.Cylindrical.qzi",
    "Subsystem.Cylindrical1.qzi",
    "Subsystem.Cylindrical2.qzi"
  };
  ...
  const char *outputPortPaths[3] = {
    "Subsystem.Cylindrical.qz",
    "Subsystem.Cylindrical1.qz",
    "Subsystem.Cylindrical2.qz"
  };

  const char *outputUnits[3] = {
    "rad",
    "rad",
    "rad"
  };

  const SizePair outputDimensions[3] = {
    { 1, 1 }, { 1, 1 }, { 1, 1 }
  };

  initIoInfoHelper(3, inputPortPaths, inputUnits, inputDimensions,
                   true, smData);
  initIoInfoHelper(3, outputPortPaths, outputUnits, outputDimensions,
                   false, smData);
}
  ...
  void initDirectFeedthrough(NeDaePrivateData *smData)
{
  ...
  const boolean_T directFeedthroughMatrix[18] = {
...
{
  PmAllocator *alloc = pm_default_allocator();
  const int32_T outputFunctionMap[3] = {
    0, 0, 0
  };

  smData->mOutputFunctionMap = pm_create_int_vector(3, alloc);
  ...
  void initAssemblyDelegate(SmMechanismDelegate *delegate)
{
  ...
  const SmSizePair jointToStageIdx[3] = {
    { 10, 0 }, { 11, 1 }, { 12, 2 }
  };
  ...
  sm_core_SmRealVector_create(&scratchpad->mMotionData, 39, 0.0);
  delegate->mSetTargets = RobotSample_49f0213f_1_setTargets;
  delegate->mResetStateVector = RobotSample_49f0213f_1_resetAsmStateVector;
  delegate->mInitializeTrackedAngleState =
    RobotSample_49f0213f_1_initializeTrackedAngleState;
  delegate->mComputeDiscreteState = RobotSample_49f0213f_1_computeDiscreteState;
  delegate->mAdjustPosition = RobotSample_49f0213f_1_adjustPosition;
  delegate->mPerturbJointPrimitiveState =
    RobotSample_49f0213f_1_perturbAsmJointPrimitiveState;
  delegate->mPerturbFlexibleBodyState = NULL;
  delegate->mComputePosDofBlendMatrix =
    RobotSample_49f0213f_1_computePosDofBlendMatrix;
  delegate->mComputeVelDofBlendMatrix =
    RobotSample_49f0213f_1_computeVelDofBlendMatrix;
  delegate->mProjectPartiallyTargetedPos =
    RobotSample_49f0213f_1_projectPartiallyTargetedPos;
  delegate->mPropagateMotion = RobotSample_49f0213f_1_propagateMotion;
  delegate->mComputeAssemblyError = RobotSample_49f0213f_1_computeAssemblyError;
  delegate->mComputeAssemblyJacobian =
    RobotSample_49f0213f_1_computeAssemblyJacobian;
  delegate->mComputeFullAssemblyJacobian =
    RobotSample_49f0213f_1_computeFullAssemblyJacobian;
  delegate->mIsInKinematicSingularity =
    RobotSample_49f0213f_1_isInKinematicSingularity;
  delegate->mConvertStateVector = RobotSample_49f0213f_1_convertStateVector;
  ...
  void initSimulationDelegate(SmMechanismDelegate *delegate)
{
  ...
  delegate->mResetStateVector = RobotSample_49f0213f_1_resetSimStateVector;
  delegate->mInitializeTrackedAngleState = NULL;
  delegate->mComputeDiscreteState = NULL;
  delegate->mAdjustPosition = NULL;
  delegate->mPerturbJointPrimitiveState =
    RobotSample_49f0213f_1_perturbSimJointPrimitiveState;
  delegate->mPerturbFlexibleBodyState =
    RobotSample_49f0213f_1_perturbFlexibleBodyState;
  ...
  delegate->mConstructStateVector = RobotSample_49f0213f_1_constructStateVector;
  delegate->mExtractSolverStateVector =
    RobotSample_49f0213f_1_extractSolverStateVector;
  delegate->mIsPositionViolation = RobotSample_49f0213f_1_isPositionViolation;
  delegate->mIsVelocityViolation = RobotSample_49f0213f_1_isVelocityViolation;
  delegate->mProjectStateSim = RobotSample_49f0213f_1_projectStateSim;
  delegate->mComputeConstraintError =
    RobotSample_49f0213f_1_computeConstraintError;
  delegate->mResetModeVector = RobotSample_49f0213f_1_resetModeVector;
  delegate->mHasJointDisToNormModeChange =
    RobotSample_49f0213f_1_hasJointDisToNormModeChange;
  delegate->mPerformJointDisToNormModeChange =
    RobotSample_49f0213f_1_performJointDisToNormModeChange;
  delegate->mOnModeChangedCutJoints =
    RobotSample_49f0213f_1_onModeChangedCutJoints;
  delegate->mMech = NULL;
}
...
void RobotSample_49f0213f_1_NeDaePrivateData_create(NeDaePrivateData *smData)
{
