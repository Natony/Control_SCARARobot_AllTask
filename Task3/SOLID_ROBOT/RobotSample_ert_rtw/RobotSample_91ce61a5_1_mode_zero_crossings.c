...
const NeZCData *RobotSample_91ce61a5_1_ZCData = NULL;
PmfMessageId RobotSample_91ce61a5_1_computeAsmModeVector(const double *input,
...
PmfMessageId RobotSample_91ce61a5_1_computeSimModeVector(const double *input,
  const double *inputDot, const double *inputDdot, int *modeVector, double
  *errorResult, NeuDiagnosticManager *neDiagMgr)
{
  (void) input;
...
PmfMessageId RobotSample_91ce61a5_1_computeZeroCrossings(const
