###########################################################################
## Makefile generated for component 'Servo_Control'. 
## 
## Makefile     : Servo_Control.mk
## Generated on : Mon Oct 09 17:00:13 2023
...
SLIB_PATH                 = C:/Users/nguye/DOCUME~1/MATLAB/R2022b/ARDUIN~1/ARDUIN~1.0/FASTER~1
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
DEFINES_STANDARD = -DMODEL=Servo_Control -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_ServoWriteRead.o xcp_ext_mode.o Servo_Control.o Servo_Control_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_serial_daemon.o
...
%.S.o : $(START_DIR)/Servo_Control_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
Servo_Control.o : $(START_DIR)/Servo_Control_ert_rtw/Servo_Control.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Servo_Control_data.o : $(START_DIR)/Servo_Control_ert_rtw/Servo_Control_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Servo_Control_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
