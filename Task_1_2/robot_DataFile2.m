...
smiData.Solid(1).mass = 0.35743189395913427;  % kg
smiData.Solid(1).CoM = [56.319465635413081 -40 15];  % mm
smiData.Solid(1).MoI = [212.98044551991708 841.03063695160017 1000.396298377647];  % kg*mm^2
smiData.Solid(1).PoI = [0 0 0];  % kg*mm^2
smiData.Solid(1).color = [0.792156862745098 0.81960784313725488 0.93333333333333335];
smiData.Solid(1).opacity = 1;
smiData.Solid(1).ID = "Link4_2*:*Default";

%Inertia Type - Custom
%Visual Properties - Simple
smiData.Solid(2).mass = 1.9741591447815656;  % kg
smiData.Solid(2).CoM = [11.807423740147556 0 71.046262400762984];  % mm
smiData.Solid(2).MoI = [10822.298411224472 12606.043865187497 7362.8600462055729];  % kg*mm^2
smiData.Solid(2).PoI = [0 -2303.1339252687121 0];  % kg*mm^2
smiData.Solid(2).color = [0.792156862745098 0.81960784313725488 0.93333333333333335];
smiData.Solid(2).opacity = 1;
smiData.Solid(2).ID = "de*:*Default";

%Inertia Type - Custom
%Visual Properties - Simple
smiData.Solid(3).mass = 0.75079644737230977;  % kg
smiData.Solid(3).CoM = [137.55304016655225 -40 16.506364819986267];  % mm
smiData.Solid(3).MoI = [468.85385468586264 6151.7387285758305 6443.5220317878166];  % kg*mm^2
smiData.Solid(3).PoI = [0 -127.17451545525525 0];  % kg*mm^2
smiData.Solid(3).color = [0.792156862745098 0.81960784313725488 0.93333333333333335];
smiData.Solid(3).opacity = 1;
smiData.Solid(3).ID = "Link1_2*:*Default";

%Inertia Type - Custom
%Visual Properties - Simple
smiData.Solid(4).mass = 0.75079644737230999;  % kg
smiData.Solid(4).CoM = [137.55304016655228 -40 16.506364819986278];  % mm
smiData.Solid(4).MoI = [468.85385468586287 6151.7387285758332 6443.5220317878193];  % kg*mm^2
smiData.Solid(4).PoI = [0 -127.17451545525593 0];  % kg*mm^2
