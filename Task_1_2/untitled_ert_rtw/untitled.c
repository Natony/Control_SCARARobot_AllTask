 ...
 * C/C++ source code generated on : Mon Dec  4 10:10:28 2023
 *
...
void untitled_step(void)
{
  ...
  if (untitled_P.ManualSwitch_CurrentSetting == 1) {
     ...
     *  Sin: '<Root>/Sine Wave'
     */
    untitled_B.ManualSwitch = sin(untitled_P.SineWave_Freq *
      untitled_M->Timing.t[0] + untitled_P.SineWave_Phase) *
  ...
  if (untitled_B.ManualSwitch + 90.0 < 0.0) {
    tmp = 0U;
  } else if (untitled_B.ManualSwitch + 90.0 > 180.0) {
    tmp = 180U;
  } else {
    tmp_0 = rt_roundd_snf(untitled_B.ManualSwitch + 90.0);
    if (tmp_0 < 256.0) {
      if (tmp_0 >= 0.0) {
        tmp = (uint8_T)tmp_0;
      } else {
...
void untitled_initialize(void)
{
  ...
  /* External mode info */
  untitled_M->Sizes.checksums[0] = (2584440025U);
  untitled_M->Sizes.checksums[1] = (1238416362U);
  untitled_M->Sizes.checksums[2] = (4256420117U);
  untitled_M->Sizes.checksums[3] = (90642764U);
